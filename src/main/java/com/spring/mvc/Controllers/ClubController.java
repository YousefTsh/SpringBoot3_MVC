...
public class ClubController {
    ...
    @GetMapping("/clubs")
    public String ListClubs(Model model, @RequestParam(name = "test",required = false) String test, HttpServletRequest request){
//        System.out.println(request.getAttribute("REQUEST_ID")); //get atteribute didnt return the value
//        System.out.println(request.getAttribute("test"));
//        System.out.println(request.getParameter("test")); // get parameter is used to value from the request
//        System.out.println(test); // @RequestParam annotation it go to httpserveletrequest and get paramenter with name test and set it in the given var
